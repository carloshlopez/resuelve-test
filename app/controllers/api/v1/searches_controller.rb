  ...
  module V1
    class SearchesController < InheritedResources::Base
      ...
      def get_result
        ...
        render json: {result: @search.result, num_external_calls: @search.scraps.count, id: @search.external_id, start: @search.start, finish: @search.finish, time_spent_in_miliseconds: @search.time_spent_in_miliseconds}
      end
